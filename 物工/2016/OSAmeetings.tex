...
\subsection*{\large{[6]}}
また，$p_2$が$p_1$に作るポテンシャルを考える．原点を$p_2$にして
\begin{eqnarray}
  \bm{E}_2 = \frac{p_2}{4\pi\epsilon_0l^3}( 2\cos(\pi-\theta_2)\bm{e}_r+\sin(\pi-\theta_2)\bm{e}_\theta) =\frac{p_2}{4\pi\epsilon_0l^3}\left( -2\cos\theta_2\bm{e}_r - \sin\theta_2\bm{e}_\theta \right)
\end{eqnarray}
であり，
図より
\begin{eqnarray}
  \bm{p}_1\cdot\bm{e}_r = \cos(\pi-\theta_1) = -p_1\cos(\theta_1), \quad \bm{p}_1\cdot\bm{e}_\theta = p_1\sin\theta_1
\end{eqnarray}
であるため，
\begin{eqnarray}
  U_2 = -\bm{p}_1\cdot\bm{E}_2 = -\frac{p_1p_2}{4\pi\epsilon_0l^3} \left( 2\cos\theta_1\cos\theta_2- \sin\theta_1\sin\theta_2\right)
\end{eqnarray}
となり同じになる．よって，全体のポテンシャルは
\begin{eqnarray}
  U = U_1 + U_2 = -\frac{p_1p_2}{2\pi\epsilon_0l^3} \left( 2\cos\theta_1\cos\theta_2- \sin\theta_1\sin\theta_2\right)
\end{eqnarray}
であり，これが最小となる$\theta_1,\theta_2$を求めれば良い．よって
\begin{eqnarray}
  \frac{\partial}{\partial\theta_1}U &&= -\frac{p_1p_2}{2\pi\epsilon_0l^3} \left( -2\sin\theta_1\cos\theta_2- \cos\theta_1\sin\theta_2\right) =0\\
  \frac{\partial}{\partial\theta_2}U &&= -\frac{p_1p_2}{2\pi\epsilon_0l^3} \left( -2\cos\theta_1\sin\theta_2- \sin\theta_1\cos\theta_2\right) =0
\end{eqnarray}
よってこれは$\theta_1,\theta_2$に関して対称ゆえそれぞれ同じ値になるため
\begin{eqnarray}
  \sin(2\theta)=0,\quad\therefore \theta_1,\theta_2 = \frac{n\pi}{2}, \quad n\in \mathbb{Z}
\end{eqnarray}
である．ただし，$\theta_1,\theta_2$の整数$n$は同じ値であるとは限らない．(しっかりHesse行列から調べる必要が大いにあるが，)例えば$\theta_1=\theta_2=0$の時，
\begin{eqnarray}
  U =  -\frac{p_1p_2}{\pi\epsilon_0l^3}
\end{eqnarray}
である．あと，三角不等式からもしっかり調べられる．
\subsection*{\large{[7]}}
鏡像の電気双極子を考える．すると，$\theta_1=-\alpha,\theta_2=\alpha$とした場合と変わらないため，
\begin{eqnarray}
  U = -\frac{p_1p_2}{2\pi\epsilon_0(2h)^3}\left( -2\cos^2(\alpha)-\sin^2(\alpha) \right) = \frac{p_1p_2}{2\pi\epsilon_0(2h)^3}\left( 2\cos^2(\alpha)+1-\cos^2(\alpha) \right)
\end{eqnarray}
であり，これが最小になるのは，
\begin{eqnarray}
  \cos\alpha = 0,\quad\therefore \alpha = \frac{(2n+1)\pi}{2},\quad n\in\mathbb{Z}
\end{eqnarray}
である．
\end{document}